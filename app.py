...
# 1. Generate Synthetic Data (e.g., Predicting House Price based on Size and Bedrooms)
np.random.seed(42)
n_points = 150
...
with col1:
    ...
    if dimension == "2D View (Ignore $X_2$)":
        ...
        **Current View: Simple Linear Regression ($Y = \beta_0 + \beta_1 X_1$)**
        ...
        We are pretending the second variable ($X_2$) doesn't exist. We projects all data points onto a flat wall. 
